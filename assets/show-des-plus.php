    ...
    <div class="tab-container">
        <nav>
            <div class="nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-home-tab" data-target="#nav-home"
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <ol>
                    <li>
                        Chuẩn bị bề mặt 
                        <p>– Bề mặt mới: Để khô bề mặt sau 28 ngày trong điều kiện bình thường (nhiệt độ tối thiểu bề mặt phải đạt từ 10°C và ít nhất phải lớn hơn 3°C so với điểm sương của không khí, độ ẩm tương đối 80%), độ ẩm bề mặt phải nhỏ hơn 16% (đo bằng Protimeter). Loại bỏ hết bụi bẩn, dầu mỡ khỏi bề mặt cần sơn để có bề mặt nhẵn mịn.</p>
                        <p>– Bề mặt cũ: Làm sạch bề mặt loại bỏ bụi bẩn, lớp sơn cũ. Xử lý bề mặt bị rong rêu, nấm mốc bằng hóa chất thích hợp. Rửa sạch bề mặt (nếu cần) và để khô ráo hoàn toàn, độ ẩm bề mặt phải nhỏ hơn 16% (đo bằng Protimeter).</p>
                    </li>

                    <li>Khuấy đều thùng sơn trước khi sử dụng. Dùng Rulo, cọ lăn hay Máy phun sơn để thi công.</li>
                    <li>Sau khi mở nắp phải sử dụng hết, làm sạch những nơi bị dính sơn bằng nước sạch ngay khi sơn xong.</li>
                </ol>

                <h4>Hệ thống sơn đề nghị</h4>
            ...
            <div class="tab-pane" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                <form class="custom-form">
                    ...
                    <div class="mb-3">
                        <label for="commentTextarea" class="form-label">Nhận xét của bạn</label>
