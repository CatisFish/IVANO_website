            ...
            <?php if (!empty($employees)): ?>
                <?php foreach ($employees as $employee): ?>
                    <tr>
                        ...
                        <td>
                            <a href="employee.php?delete_employee=<?php echo $employee['employee_id']; ?>"
                                onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này không?')">Xóa</a>
                            <!-- Bổ sung liên kết để chuyển đến trang chỉnh sửa nhân viên -->
                            <a href="edit_employee.php?employee_id=<?php echo $employee['employee_id']; ?>">Sửa</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
